...
|---------|------|------|------------|-----------|
| PM<sub>(리더)</sub> | **유서현 (Seohyeon Yoo)** | DataScience | - 프로젝트 기획 및 회의 총괄<br>- UI/UX 설계 및 디자인 주도<br>- 유저테스트 담당<br>- 논문 작성 및 발표<br>- 프론트엔드 UI/UX 개발 보조 | ✉️dbtjgus6988@gmail.com<br>🔗 [GitHub](https://github.com/dbtjgus6988) |
